...
@else
<form action="{{route('insurances.save',['item'=>$item?->id])}}" class="saveForm" enctype="multipart/form-data">
    ...
    <div class="form-items">
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-input">
                            <input type="number" name="insurance_fee" value="{{ $item->insurance_fee }}">
                            <span>azn</span>
                        </div>
                    </div>
