...
.tr-yellow {
  ...
  <div class="insurance-container">
            <div class="insurance-container-head">
                <h1>Siğorta</h1>
                <div class="head-buttons">
                    <a href="{{ route('insurances.export') }}" class="export_excel">
                    ...
                    <button class="addNewInsurance addNewUsers addItem" type="button">
                       ...
                       Yeni sığorta əlavə et
                    </button>
                </div>
            </div>
            <div class="insurance-body">
                <div class="insurance-body-head">
...
<script>
    $(function() {
        let tableId = '{{ $tableId ?? "insurances" }}';
