                    ...
                    <div class="driversListBox">
                      ...
                      <div class="driversList">
                        ...
                        <div class="driverItem">
                          <input type="checkbox" data-value="{{ $driver->fullName }}" name="drivers[]" value="{{ $driver->id }}"/>
                          <p>{{ $driver->fullName }}</p>
                        </div>
                        @endforeach
                      </div>
...
<script>
    $(function() {
            ...
            $.ajax({
              ...
              success:function(e){
                ...
                drivers.forEach(function(driver){
                  $(".driverItem input[value='"+driver+"']").prop("checked","checked")
                })
        ...
        $("body").on("change", "input[name='drivers[]']", function(e){
            ...
            var id = $(this).val();
            var html = "<div class='selectedItem'><p>"+text+"</p><button data-id='"+id+"' class='remoceSelectItem' type='button'><svg width='11' height='10' viewBox='0 0 11 10' fill='none' xmlns='http://www.w3.org/2000/svg'><path d='M1 0.5L10 9.5M1 9.5L10 0.5' stroke='white'></path></svg></button></div>";
            if ($(this).is(":checked")) {
