<div class="action">
    ...
    <div class="action-links">
        ...
        <a href="{{ route('deposits.show',$item->id) }}" class="view_link action-link">
            <img src="../assets/icons/eye_yellow.svg" alt="">
            Baxış
        </a>
        <button data-permission="deposits" class="deleteTableRow action-link" data-id="{{ $item->id }}" data-model="{{ get_class($item) }}">
