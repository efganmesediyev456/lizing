...
@section('content')
    <div class="deposits-container">
        <div class="deposits-container-head">
            <h1>Depozitlər</h1>
            <div class="head-buttons">
                <a href="{{ route('deposits.export') }}" class="export_excel">
                ...
                {{-- <button class="addNewDeposits  addNewUsers addItem" type="button">
                    ...
                    <div class="form_inner">
                        ...
                        <div class="form_item">
                            ...
                            <select class="filter-input select2" name="status_id">
                                <option value="">Seçin</option>
                                    <option value="deposit_debt">Depozit borcu</option>
                                    <option value="deposit_payment">Ilkin Depozit</option>
                            </select>
                        </div>
                        ...
                        <div class="form_item">
                         ...
                         <div class="form_item">
                            <label>Başlanğıc Ödəniş tarixi</label>
                            <input type="date" name="start_created_at" class="filter-input">
                        </div>


                        <div class="form_item">
                            <label>Bitirmə Ödəniş tarixi</label>
...
@push('js')
    ...
    <script>
        $(function() {
            let tableId = '{{ $tableId ?? 'deposits_table' }}';
            ...
            $("body").on('click', '.editItem', function() {
                ...
                $.ajax({
                    url: "{{ route('driver-notification-topic.form') }}" + "/" + id,
                    type: "post",
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
