...
@section('content')
    <div class="oilChange-container">
        <div class="oilChange-container-head">
            <h1>Yağın dəyişilməsi</h1>
            <div class="head-buttons">
                ...
                <button class="addNewOilChange addNewUsers addItem" type="button">
        ...
        <div class="oilChange-body">
            <div class="oilChange-body-head">
...
@push('js')
    ...
    <script>
        $(function() {
            let tableId = '{{ $tableId ?? 'oil_changes' }}';
