...
@section('content')
 ...
 <div class="credit-container">
            <div class="credit-container-head">
                <h1>Kreditlər</h1>
                <div class="head-buttons">
                    ...
                    <button class="addNewCredit addNewUsers addItem" type="button">
...
<script>
    $(function() {
        let tableId = '{{ $tableId ?? "credits-table" }}';
        ...
        initFileInputUploadStyle('.notificationImage');
    ...
    // Kredit hesablamalarını yapan fonksiyon
    function calculateLoanDetails() {
        ...
        const totalMonths = parseFloat($('#total_months').val()) || 0;
        const remainingMonths = parseFloat($('input[name="remaining_months"]').val()) || 0;

        // Toplam ödenecek kredi tutarını hesapla
        const totalPayableLoan = (monthlyPayment * totalMonths);
        $('#total_payable_loan').val(totalPayableLoan.toFixed(2));

        // Kalan miktarı hesapla
        const remainingAmount = totalPayableLoan - (monthlyPayment * (totalMonths - remainingMonths));
        $('input[name="remaining_amount"]').val(remainingAmount.toFixed(2));
    }

    // Body üzerinden tüm ilgili inputları dinle
    $("body").on('input', 'input[name="down_payment"], input[name="monthly_payment"], input[name="total_months"], input[name="remaining_months"]', function() {
