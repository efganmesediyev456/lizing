...
@section('content')
        ...
        <div class="brand-container">
            <div class="brand-container-head">
                <h1>Sürücü bildiriş mövzuları</h1>
                <div class="head-buttons">
                    ...
                    <button class="addNewBrand addNewUsers addItem" type="button">
                        ...
                        Yeni Sürücü bildiriş mövzusu Əlavə et
                    </button>
                </div>
            </div>
...
<script>
    $(function() {
        let tableId = '{{ $tableId ?? "driver-notification-topics-table" }}';
        ...
        $(".addItem").click(function() {
            ...
            $(".saveForm").remove()
            $.ajax({
                url: "{{ route('driver-notification-topic.form') }}",
                type: "post",
                data: {
                    _token: '{{csrf_token()}}'
                },
