...
@section('content')
    <div class="brand-container">
        <div class="brand-container-head">
            <h1>Nəqliyyat Vasitəsi Statusları</h1>
            <div class="head-buttons">
                <a href="{{ route('vehicle-statuses.export') }}" class="export_excel">
                ...
                <button class="addNewBrand addNewUsers addItem" type="button">
                    ...
                    Yeni Nəqliyyat Vasitəsi Statusları Əlavə et
                </button>
            </div>
        </div>
    ...
    @include('vehicle-statuses.components.pagination-result')
    @include('vehicle-statuses.components.success-modal')
@endsection
...
<script>
    $(function() {
        let tableId = '{{ $tableId ?? "vehicle-statuses-table" }}';
        ...
        $(".addItem").click(function() {
            ...
            $.ajax({
                url: "{{ route('vehicle-statuses.form') }}",
                type: "post",
                data: {
                    _token: '{{csrf_token()}}'
                },
        ...
        $("body").on('click', '.editItem', function() {
            ...
            $.ajax({
                url: "{{ route('vehicle-statuses.form') }}" + "/" + id,
                type: "post",
                data: {
                    _token: '{{csrf_token()}}'
                },
