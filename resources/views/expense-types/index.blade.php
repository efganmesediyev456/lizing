...
@section('content')
        ...
        <div class="banType-container">
            <div class="banType-container-head">
                <h1>Xərc növü</h1>
                <div class="head-buttons">
                    <a href="{{ route('expense-types.export') }}" class="export_excel">
                    ...
                    <button class="addNewBanType addNewUsers addItem" type="button">
                       ...
                       Yeni Xərc növü Əlavə et
                    </button>
                </div>
            </div>
            <div class="banType-body">
                <div class="banType-body-head">
...
<script>
    $(function() {
        let tableId = '{{ $tableId ?? "expense-types-table" }}';
        ...
        $("body").on('click', '.editItem', function() {
            ...
            $.ajax({
                url: "{{ route('expense-types.form') }}" + "/" + id,
                type: "post",
                data: {
                    _token: '{{csrf_token()}}'
                },
