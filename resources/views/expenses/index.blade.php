...
@section('content')
    <div class="expenses-container">
        <div class="expenses-container-head">
            <h1>Xərclər</h1>
            <div class="head-buttons">
                <a href="{{ route('expenses.export') }}" class="export_excel">
                ...
                <button class="addNewExpenses addNewUsers addItem" type="button">
...
@push('js')
    ...
    <script>
        $(function() {
            let tableId = '{{ $tableId ?? 'expenses-table' }}';
