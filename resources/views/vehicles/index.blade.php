...
<div class="auto-container">
    <div class="auto-container-head">
        ...
        <div class="head-buttons">
            <a href="{{  route('vehicles.export') }}" class="export_excel">
        ...
        <div class="filter-container">
            <form id="vehicleFilter" class="generalSearch">
                <div class="form_inner">
                    <div class="form_item">
                        <label>Marka</label>
                        <select class="filter-input" name="brand_id">
                    ...
                    <div class="form_item">
                        <label>Model</label>
                        <select class="filter-input" name="model_id">
                            <option value="">Seçin</option>
                    ...
                    <div class="form_item">
                        <label>Status</label>
                        <select class="filter-input" name="status_id">
                            <option value="">Seçin</option>
                    ...
                    <div class="form_item">
                        <label>Reklam</label>
                        <select class="filter-input" name="has_advertisement">
                            <option value="">Seçin</option>
                     ...
                     <div class="form_item">
                        ...
                        <select class="filter-input" name="table_id_number">
                            <option value="">Seçin</option>
                    ...
                    <div class="form_item">
                        <label>Texniki Baxış başlama tarixi</label>
                        <input type="date" name="technical_start" class="filter-input">
                    </div>


                    <div class="form_item">
                        <label>Texniki Baxış bitmə tarixi</label>
                                            <input type="date" name="technical_end" class="filter-input">
                    </div>
                    ...
                    <div class="form_item">
                        ...
                        <input type="date" name="insurance_start" class="filter-input">
                    </div>


                    <div class="form_item">
                        <label>Sığorta bitmə tarixi</label>
                                            <input type="date" name="insurance_end" class="filter-input">
                    </div>
