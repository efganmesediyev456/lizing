    ...
    <div class="header-left">
        <button class="aside_resize_btn" type="button">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 5H21M3 12H21M3 19H21" stroke="#0A0A0B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
        </button>
...
<div class="auto-container">
    <div class="auto-container-head">
        ...
        <div class="head-buttons">
            ...
            <button class="addNewAuto addNewUsers addItem" type="button">
...
<script>
    $(function() {
        let tableId = '{{ $tableId ?? "vehicles-table" }}';
        ...
        initFileInputUploadStyle2('.id_card_front');
        initFileInputUploadStyle2('.id_card_back');
    });
</script>
