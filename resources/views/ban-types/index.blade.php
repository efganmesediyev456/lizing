        ...
        <div class="banType-container">
            <div class="banType-container-head">
                ...
                <div class="head-buttons">
                    <a href="{{ route('ban-types.export') }}" class="export_excel">
...
<script>
    $(function() {
        let tableId = '{{ $tableId ?? "ban-types-table" }}';
