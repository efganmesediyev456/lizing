...
@section('content')
 ...
 <div class="debt-container">
            <div class="debt-container-head">
                <h1>Borclar</h1>
                <div class="head-buttons">
                    <a href="{{ route('debts.export') }}" class="export_excel">
                    ...
                    <button class="addNewDebt addNewUsers addItem" type="button">
...
<script>
    $(function() {
        let tableId = '{{ $tableId ?? "debts-table" }}';
