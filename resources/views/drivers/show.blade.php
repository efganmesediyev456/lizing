            ...
            <div class="viewDrivers-form">
                <div class="form-items">
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-input">
                            <input type="text"
                                value="{{ $item->gender === 0 ? 'Kişi' : ($item->gender === 1 ? 'Qadın' : '') }}">
                        </div>
                    </div>
                    <div class="form-item">
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-input">
                            <input type="text"
                                value="{{ $item->daily_payment === 0 ? 'Deaktiv' : ($item->daily_payment === 1 ? 'Aktiv' : '') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-input">
                            <input type="text"
                                value="{{ $item->monthy_payment === 0 ? 'Deaktiv' : ($item->monthy_payment === 1 ? 'Aktiv' : '') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-input">
                            <input type="text"
                                value="{{ $item->deposit_payment === 0 ? 'Deaktiv' : ($item->deposit_payment === 1 ? 'Aktiv' : '') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-item">
                        ...
                        <div class="form-input">
                            <input type="text"
                                value="{{ $item->first_deposit_payment === 0 ? 'Deaktiv' : ($item->first_deposit_payment === 1 ? 'Aktiv' : '') }}">
                        </div>
                    </div>
                            ...
                            <div class="document-item">
                                ...
                                @if($item->id_card_front)
                                    ...
                                    <div class="document-actions">
                                        <a href="/storage/{{ $item->id_card_front }}" class="viewDocument"
                                            target="_blank">
                        ...
                        <div class="document-list">
                          @if($item->drivers_license_front)
                            <div class="document-item">
                                ...
                                <div class="document-actions">
                                    <a href="/storage/" class="viewDocument" target="_blank">
                                        <img src="../assets/icons/eye-gray.svg" alt="">
                                    </a>
                                    <button class="deleteDocument">
                                        <img src="../assets/icons/trash-gray.svg" alt="">
