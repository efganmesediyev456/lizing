...
<style>
.tr-red {
    background-color: #ff9999 !important; /* açıq qırmızı */
    color: #000; /* tünd yazı daha oxunaqlı */
}

.tr-green {
    background-color: #b7eb8f !important; /* açıq yaşıl */
    color: #000;
}

.tr-yellow {
    background-color: #fff566 !important; /* açıq sarı */
    color: #000;
}
...
<div class="technical-container">
            <div class="technical-container-head">
                <h1>Texniki baxış</h1>
                <div class="head-buttons">
                    <a href="{{ route('technical_reviews.export') }}" class="export_excel">
                    ...
                    <button class="addNewTechnical addNewUsers addItem" type="button">
                       ...
                       Yeni texniki baxış əlavə et
                    </button>
                </div>
            </div>
            <div class="technical-body">
                <div class="technical-body-head">
...
<script>
    $(function() {
        let tableId = '{{ $tableId ?? "technical-reviews" }}';
        ...
        $(".addItem").click(function() {
            ...
            $.ajax({
                url: "{{ route('technical_reviews.form') }}",
                type: "post",
                data: {
                    _token: '{{csrf_token()}}'
                },
        ...
        $("body").on('click', '.editItem', function() {
            ...
            $.ajax({
                url: "{{ route('technical_reviews.form') }}" + "/" + id,
                type: "post",
                data: {
                    _token: '{{csrf_token()}}'
                },
        ...
        $('body').on('submit', '.saveForm', function(e) {
            ...
            $.ajax({
                ...
                success: function(e) {
                    ...
                    // $(".success-modal-container").find('h2').text('Uğurla əlavə olundu !')
