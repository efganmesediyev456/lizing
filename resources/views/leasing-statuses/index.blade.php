...
@section('content')
    <div class="brand-container">
        <div class="brand-container-head">
            <h1>Lizinq Statusları</h1>
            <div class="head-buttons">
                <a href="{{ route('leasing-statuses.export') }}" class="export_excel">
                ...
                <button class="addNewBrand addNewUsers addItem" type="button">
    ...
    <!-- Similar pagination and success modal sections as in penalty-types index view -->
    @include('leasing-statuses.components.pagination-result')
    @include('leasing-statuses.components.success-modal')
@endsection
...
<script>
    $(function() {
        let tableId = '{{ $tableId ?? "leasing-statuses-table" }}';
        ...
        $(".addItem").click(function() {
            ...
            $.ajax({
                url: "{{ route('leasing-statuses.form') }}",
                type: "post",
                data: {
                    _token: '{{csrf_token()}}'
                },
        ...
        $("body").on('click', '.editItem', function() {
            ...
            $.ajax({
                url: "{{ route('leasing-statuses.form') }}" + "/" + id,
                type: "post",
                data: {
                    _token: '{{csrf_token()}}'
                },
