...
@section('content')
  ...
  <div class="leasing-container">
            ...
            <div class="drivers-tabs">
                    <a href="{{ route('leasing.index') }}" class="driver-tab" data-id="all">Hamısı</a>
                    <a href="{{ route('leasing.active') }}" class="driver-tab active" data-id="">Aktiv borclular</a>
        ...
        <div class="add-driver-container" id="createPayment">
         ...
         <div class="success-modal-container" style="display: none;">
            <div class="success-modal">
                ...
                <img src="{{ asset('ssets/images/success.svg') }}" alt="">
        ...
        $('body').on('submit', '.saveForm', function(e) {
         ...
         $("body").on("input", "[name='deposit_price'], [name='deposit_payment']", function(e){
           ...
           if(depositPrice<depositPayment){
            $("[name='deposit_payment']").parent().after('<p class="removeErr" style="color:red">Depozit ödənişi Depozit qiymətindən böyük ola bilməz</p>');
           }
         })
    ...
    $.ajax({
        ...
        error: function(xhr, status, error) {
            if (xhr.status !== 422) {
                ...
                errorModal.find("p").text(xhr.responseJSON.message || "Naməlum xəta baş verdi");
