...
<div class="viewUser-container">
            <a href="{{ route('users.index') }}" class="backLink">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M20 11H7.83L13.42 5.41L12 4L4 12L12 20L13.41 18.59L7.83 13H20V11Z" fill="#131527"/>
                </svg>
                Geri
            </a>
            <div class="viewUser-container-head">
                <h1>İstifadəçi məlumatları:{{ $item->name.' '.$item->surname }}  </h1>
            </div>
            <div class="viewUser-body">
                <div class="viewUser-body-head">
                    <h2>Ümumi Məlumatlar</h2>
                </div>
                <div class="viewUser-form">
                    <div class="form-items">
                        ...
                        <div class="form-item">
                            <label for="">Rol</label>
                            <select name="" id="">
                                <option>{{ $item->roles?->first()?->name }}</option>
                            </select>
                        </div>
                        <div class="form-item">
                      ...
                      <div class="document-list">
                        <div class="document-item">
                          <div class="document-title">
                            ...
                            @php
                                $parts = explode('/', $item->id_card_front);
                                $fileName = end($parts);
                            @endphp
                        ...
                        <div class="document-item">
                          <div class="document-title">
                            <img src="../assets/icons/documentIcon.svg" alt="">
                            @php
                                $parts = explode('/', $item->id_card_back);
                                $fileName = end($parts);
                            @endphp
