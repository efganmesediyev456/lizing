        ...
        <div class="users-container">
            <div class="users-container-head">
                ...
                <div class="head-buttons">
                    ...
                    <button class="addNewUsers addItem" type="button">
                ...
                <div class="users-table">
                    <table>
                        ...
                        <tbody>
                                ...
                                <td>{{$user->fin}}</td>
                                <td>
                                    <!-- bunlardan biri olmalidi, digerini kommente atiram -->
                                    <p class="activeUser">
                                        <span></span>
                                        Active
                                    </p>
                                    <!-- <p class="deactiveUser">
                                        <span></span>
                                        Deactive
                                    </p> -->
                                </td>
                                <td>
                                    <div class="action">
                                        ...
                                        <div class="action-links">
                                            <button class="editUserBtn action-link editItem" data-id="{{$user->id}}" type="button">
